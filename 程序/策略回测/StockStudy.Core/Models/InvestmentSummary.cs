    ...
    public class InvestmentSummary
    {
        ...
        public string GetSummary()
        {
            return
                ...
                $"基准期初价格: {First.Close:0.000}, 期末价格: {Last.Close:0.000}, 基准收益: {BaseEarnings:0.000}, 基准收益率: {(Last.Close - First.Close) / Last.Close:0.000%} {Environment.NewLine}" +
                $"采用 {StrategyName} 超额收益: {OverEarnings:0.000}, 超额收益率:{OverEarnings / BaseEarnings:0.000%} ";
