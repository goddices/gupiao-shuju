...
namespace StockStudy.EastmoneyImpl
{
    public class EastmoneyQuoteReader : IQuoteReader
    {
        ...
        public async Task<StockQuote?> ReadQuoteAsync(Market market, string stockCode, AdjustPriceType adjustType, PeriodType periodType, CancellationToken token = default)
        {
            var marketCode = market switch { Market.Shengzhen => "0", Market.Shanghai => "1", _ => "" };
            ...
            var url = $"https://push2his.eastmoney.com/api/qt/stock/kline/get?cb={randomString}&secid={marketCode}.{stockCode}&ut=fa5fd1943c7b386f172d6893dbfba10b&fields1=f1,f2,f3,f4,f5,f6&fields2=f51,f52,f53,f54,f55,f56,f57,f58,f59,f60,f61&klt={klt}&fqt={fqt}&end=20500101&lmt=744&_=1716992167964";
